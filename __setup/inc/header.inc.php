...
<head>
    ...
    <link rel="stylesheet" href="css/wizard.css?c1b5a33"/>
    <link type="text/css" rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/flags.css?c1b5a33"/>
    <script type="text/javascript" src="../js/jquery-1.8.3.min.js?c1b5a33"></script>
    <script type="text/javascript" src="js/tips.js?c1b5a33"></script>
    <script type="text/javascript" src="js/setup.js?c1b5a33"></script>
</head>
<body>
    <div id="wizard">
        <div id="header">

...
<script type="text/javascript" src="js/raphael-min.js?c1b5a33"></script>
<script type="text/javascript" src="js/g.raphael.js?c1b5a33"></script>
<script type="text/javascript" src="js/g.line-min.js?c1b5a33"></script>
<script type="text/javascript" src="js/g.dot-min.js?c1b5a33"></script>
<script type="text/javascript" src="js/bootstrap-tab.js?c1b5a33"></script>
<script type="text/javascript" src="js/dashboard.inc.js?c1b5a33"></script>

<link rel="stylesheet" type="text/css" href="css/bootstrap.css?c1b5a33"/>
<link rel="stylesheet" type="text/css" href="css/dashboard.css?c1b5a33"/>
